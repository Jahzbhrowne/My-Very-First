...
<link href="bootstrap1/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link href="bootstrap1/css/business-casual.min.css" rel="stylesheet">
    ...
    <span class="site-heading-lower">Sign In Here</span>
  </h1>
    ...
    <div class="container">
      ...
      <div class="container"  >
        <div class="row">
            ...
            <div class="cta-inner text-center rounded" style="border-style: double; border-color: #e6a756;border-width: thick" >
              <h2 class="section-heading mb-5">
                ...
                <span class="section-heading-lower">Sign In Form</span>
              </h2>
        <div>     
        <form enctype="multipart/form-data" name="Myform" action="signinpage.php" method="post" class="cta">
        ...
        <input type="email" name="email" maxlength="50" style="border-radius: 1.5em; width:300px;padding:.5em">
        ...
        <p><input type="submit" placeholder="Submit" style="background-color:chocolate; border-radius: .85em;font-size:1.4em;border-style: double;border-color: brown" name="signin" value="Submit"></p>
            
        <p style="font-size:1.5em">Already have an account? <a href="loginpage.php">Login here</a></p>
        </form>
            </div>
            </div>
          </div>
